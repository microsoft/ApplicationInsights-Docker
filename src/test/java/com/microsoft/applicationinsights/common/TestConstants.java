...
public class TestConstants {
    public static final String DEFAULT_STATE_EVENT = "{'name':'docker-container-state','properties':{'docker-image':'ubuntu','Created':'2015-08-06T09:01:55.3422261Z','StartedAt':'2015-08-06T09:01:55.7843711Z','docker-container-name':'/modest_jang0','RestartCount':0,'status':'start','docker-container-id':'con_id','docker-host':'galha-ubuntu'}}";
